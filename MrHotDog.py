...
IMG_DIR="C:/Users/joleon/Desktop/BurgerTime/Proyecto Ingenieria/MrHotDog"
#Base12=[]
#Stairs12=[]
stairsandbase=[]
FacingRight= True
...
class MrHotDog(pygame.sprite.Sprite):
    frame=0
    def __init__(self,x,y,Vx,Vy):
     pygame.sprite.Sprite.__init__(self)
     self.images=[]
     for i in range(0,24):
        img = Util_Functions.load_image("MrHotDog"+str(i)+".png", IMG_DIR, alpha=True)
